...
import (
	...
	"github.com/meshx-org/timescaledb-event-streamer/internal/eventing/eventemitting"
	sinkimpl "github.com/meshx-org/timescaledb-event-streamer/internal/eventing/sink"
	"github.com/meshx-org/timescaledb-event-streamer/internal/publicationmanager"
	"github.com/meshx-org/timescaledb-event-streamer/internal/replication/logicalreplicationresolver"
	"github.com/meshx-org/timescaledb-event-streamer/internal/replication/replicationchannel"
	replicationcontextimpl "github.com/meshx-org/timescaledb-event-streamer/internal/replication/replicationcontext"
	sidechannelimpl "github.com/meshx-org/timescaledb-event-streamer/internal/sidechannel"
	"github.com/meshx-org/timescaledb-event-streamer/internal/stats"
	systemcatalogimpl "github.com/meshx-org/timescaledb-event-streamer/internal/systemcatalog"
	"github.com/meshx-org/timescaledb-event-streamer/internal/systemcatalog/snapshotting"
	taskmanagerimpl "github.com/meshx-org/timescaledb-event-streamer/internal/taskmanager"
	...
	"github.com/meshx-org/timescaledb-event-streamer/spi/stream"
...
type SnapshotterProvider = func(
	*config.Config, statestorage.Manager, sidechannel.SideChannel,
	task.TaskManager, publication.PublicationManager, pgtypes.TypeManager, *stats.Service,
